        ...
        <div className="m-10 w-80 flex flex-col justify-between">
          <div className="space-y-8">
            <div className="space-y-2">
              ...
              <button
                className="p-2 px-4 rounded-lg bg-green-600 text-sm dark:text-gray-300 hover:bg-green-700 text-white"
          ...
          <div>
            <button
              className="p-2 px-4 rounded-lg bg-gray-300 dark:bg-gray-700 hover:bg-gray-400 text-xs text-black dark:text-white"
              onClick={() => {
